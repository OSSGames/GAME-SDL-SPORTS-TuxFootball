...
#ifndef TUXFOOTBALL_MATCHABORTEDSTATE
#define TUXFOOTBALL_MATCHABORTEDSTATE

#include "statebase.h"

class GameEngine;

class MatchAbortedState : public StateBase {
public:
	MatchAbortedState(GameEngine &engine);
	virtual ~MatchAbortedState();
...
#endif /* TUXFOOTBALL_MATCHABORTEDSTATE */
