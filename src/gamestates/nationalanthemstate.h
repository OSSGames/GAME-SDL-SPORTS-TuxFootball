...
#ifndef TUXFOOTBALL_NATIONALANTHEMSTATE
#define TUXFOOTBALL_NATIONALANTHEMSTATE

#include "statebase.h"

class GameEngine;

class NationalAnthemState : public StateBase {
public:
	NationalAnthemState(GameEngine &engine);
	virtual ~NationalAnthemState();
...
#endif /* TUXFOOTBALL_NATIONALANTHEMSTATE */
