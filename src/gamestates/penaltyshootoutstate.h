...
#ifndef TUXFOOTBALL_PENALTYSHOOTOUTSTATE
#define TUXFOOTBALL_PENALTYSHOOTOUTSTATE

#include "statebase.h"

class GameEngine;

class PenaltyShootoutState : public StateBase {
public:
	PenaltyShootoutState(GameEngine &engine);
...
#endif /* TUXFOOTBALL_PENALTYSHOOTOUTSTATE */
