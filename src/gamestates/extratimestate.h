...
#ifndef TUXFOOTBALL_EXTRATIMESTATE
#define TUXFOOTBALL_EXTRATIMESTATE

#include "statebase.h"

class GameEngine;

/** State that handles the break before extra time starts. Once finished, it
 * goes into extratimefirsthalf. */
class ExtraTimeState: public StateBase {
public:
	ExtraTimeState(GameEngine &engine);
	virtual ~ExtraTimeState();
...
#endif /* TUXFOOTBALL_EXTRATIMESTATE*/
